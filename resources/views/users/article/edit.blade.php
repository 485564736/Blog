...
<div class="crumb_warp">
    ...
    <i class="fa fa-home"></i> <a href="{{url('users/info')}}">首页</a> &raquo; 文章管理
</div>
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <div class="short_wrap">
            ...
            <a href="{{url('users/article')}}"><i class="fa fa-recycle"></i>全部文章</a>
        </div>
    </div>
</div>
<!--结果集标题与导航组件 结束-->
...
<div class="result_wrap">
    <form action="{{url('users/article/'.$field->art_id)}}" method="post">
...
//                                    alert(data);
            ...
            <tr>
                ...
                <td>
                    @if($field->art_thumb=='')
                        <div align="center" style="width: 50px"><span>无图片</span></div>
                        <img alt="" id="art_thumb_img" style="max-width: 350px; max-height:100px;" src="{{asset('uploads/noavatar_default.png')}}">
                        @else
