...
class ArticleController extends CommonController
{
    ...
    public function recomart()
    {
        $data = Article::where('is_recom',1)->orderBy('art_id','desc')->paginate(10);
        return view('admin.article.recomart',compact('data'));
    }
...
//        session(['user'=>'xishuai']);
    ...
    public function store()
    {
        ...
        if($validator->passes()){
            ...
            {
                $input['art_editor']=session('user')->user_name;
